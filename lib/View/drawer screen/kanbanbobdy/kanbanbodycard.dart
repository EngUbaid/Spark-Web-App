...
class cardanotherdatas extends StatefulWidget {
  ...
  @override
  State<cardanotherdatas> createState() => _cardanotherdataState();
}

class _cardanotherdataState extends State<cardanotherdatas> {
